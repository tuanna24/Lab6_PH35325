...
public class MainActivityHome extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        arrayList.add(new Student("Fpoly Hà Nội", "Nguyễn Anh Tuấn ", "Thanh Hóa"));
        arrayList.add(new Student("Fpoly Hồ Chí Minh", "Nguyễn Xuân Hoàng Lâm", "Hải Dương"));
        arrayList.add(new Student("Fpoly Tây Nguyên", "Nguyễn Văn Hưng", "Sầm Sơn"));
        arrayList.add(new Student("Fpoly Đà Nẵng", "Nguyễn Viết Minh", "Đà Nẵng"));
        arrayList.add(new Student("Fpoly Hải Phòng", "Nguyễn Việt Anh", "Hải Phòng"));
        setChangeDataInArrayAdt();
